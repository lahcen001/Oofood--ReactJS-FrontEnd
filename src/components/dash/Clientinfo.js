...
export class Clientinfo extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(`https://oofood.herokuapp.com/api/user/${id}`)
      .then((res) => {
        this.setState({
          name: res.data.name,
              ...
              <>
                ...
                <button type="button" onClick={() => this.deleteOrder(items.id_order)}  className="btn btn-danger"><RiDeleteBin5Line/></button>
                  ...
                  <table className="table bg-white rounded shadow p-3 mr-2 mt-5  col-md-2">
                    <tr>
                      <td>
                        <h6 className="text-success">Nom et Prenom </h6>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <h6 className="text-success">Telephone</h6>{" "}
                      </td>
                      <td>
                        <h4>
                          {" "}
                    ...
                    <tr>
                      <td>
                        <h6 className="text-success">Ville </h6>{" "}
                      </td>
                      <td>
                        <h6> {this.state.ville}</h6>{" "}
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <h6 className="text-success">Adresse </h6>{" "}
                      </td>
                      <td>
