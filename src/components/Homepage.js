...
export class Homepage extends Component {
  render() {
    ...
    if (!localStorage.usertoken) {
      message = (
        <div className="row">
          <div>
            ...
            <Link
              to="/commander"
              className="btn btn-secondary btn-lg  my-2 shadow"
            >
              <h5 className="font">
                <GiFoodTruck /> Commander
              </h5>
            </Link>
          </div>
          <div className="mx-4">
            {" "}
            <Link to="/login" className="btn btn-danger btn-lg  my-2 shadow">
              <h5 className="font">
          ...
          <div>
            {" "}
            <Link to="/register" className="btn btn-danger btn-lg  my-2 shadow">
              <h5 className="font">
      ...
      message = (
        <div className="row">
          ...
          <div className="mx-4">
            {" "}
            <Link to="/profile" className="btn btn-danger btn-lg  my-2 shadow">
              <h5 className="font">
                <AiFillDashboard /> Mes Commandes
              </h5>
            </Link>
          </div>
        </div>
    ...
    const url = "https://oofood.herokuapp.com/storage/";
        ...
        <div className="bg-white pt-3">
          ...
          <div className="jumbotron jumbotron-fluid bg-white mb-0 mt-3">
            ...
            <div className="container text-white">
              ...
              <p className=" text-white font h5">
