...
export class Itemplat extends Component {
  ...
  componentWillMount() {
    ...
    axios.get(`https://oofood.herokuapp.com/api/plats/${id}`).then((res) => {
      this.setState({
        item: res.data,
      });
    });
  ...
  render() {
    ...
    const image1 = `https://oofood.herokuapp.com/storage/${this.state.item.image1}`;
    const image2 = `https://oofood.herokuapp.com/storage/${this.state.item.image2}`;
    const image3 = `https://oofood.herokuapp.com/storage/${this.state.item.image3}`;
            ...
            <div className="col-lg-4  col-md-12  col-sm-12 shadow-sm rounded p-3">
              ...
              <h2>
                ...
                <span class="badge badge-success">
                  Prix :{this.state.item.price} MAD
                </span>
              </h2>
              <br />
              <br />
              ...
              <p>{this.state.item.description1}</p>
              <br />
              <p>{this.state.item.description2}</p>
              <br />
              <h3 className="font">INGRÉDIENTS</h3>
              <p>{this.state.item.description3}</p>
              <br />
            </div>
